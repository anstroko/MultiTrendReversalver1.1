...
int start()
{
 string acc= CharToStr(51)+CharToStr(53)+CharToStr(55)+CharToStr(52)+CharToStr(54)+CharToStr(51)+CharToStr(48);
    ...
    OpenOrderSell=true;  
     ...
     {     
      ...
      case 14 : NextLotB=lot15*GoGoBuy;break;
                           ...
                           switch(CountSell)                                  // Заголовок switch
     {                                            // Начало тела switch
...
if ((CountBuy==1)&&(Ask<(StartBuyPrice-Level1*k*Point))) {
LooseNowBuy();
...
if ((CountSell==1)&&(Bid>(StartSellPrice+Level1*k*Point))) {
LooseNowSell();
Print ("Открытие 2-го ордера");
...
if ((CountBuy==2)&&(Ask<(StartBuyPrice-Level2*k*Point))) {
...
if ((CountSell==2)&&(Bid>(StartSellPrice+Level2*k*Point))) {
...
if ((CountBuy==3)&&(Ask<(StartBuyPrice-Level3*k*Point))) {
 LooseNowBuy();
...
if ((CountSell==3)&&(Bid>(StartSellPrice+Level3*k*Point))) {
...
if ((CountBuy==4)&&(Ask<(StartBuyPrice-Level4*k*Point))) {
 LooseNowBuy();
...
if ((CountSell==4)&&(Bid>(StartSellPrice+Level4*k*Point))) {
...
if ((CountBuy==5)&&(Ask<(StartBuyPrice-Level5*k*Point))) {
 LooseNowBuy();
...
if ((CountSell==5)&&(Bid>(StartSellPrice+Level5*k*Point))) {
...
if ((CountBuy==6)&&(Ask<(StartBuyPrice-Level6*k*Point))) {
 LooseNowBuy();
...
if ((CountSell==6)&&(Bid>(StartSellPrice+Level6*k*Point))) {
...
if ((CountBuy==7)&&(Ask<(StartBuyPrice-Level7*k*Point))) {
LooseNowBuy();
...
if ((CountSell==7)&&(Bid>(StartSellPrice+Level7*k*Point))) {
...
if ((CountBuy==8)&&(Ask<(StartBuyPrice-Level8*k*Point))) {
LooseNowBuy();
...
if ((CountSell==8)&&(Bid>(StartSellPrice+Level8*k*Point))) {
...
if ((CountBuy==9)&&(Ask<(StartBuyPrice-Level9*k*Point))) {
LooseNowBuy();
...
if ((CountSell==9)&&(Bid>(StartSellPrice+Level9*k*Point))) {
...
if ((CountBuy==10)&&(Ask<(StartBuyPrice-Level10*k*Point))) {
LooseNowBuy();
...
if ((CountSell==10)&&(Bid>(StartSellPrice+Level10*k*Point))) {
...
if ((CountBuy==11)&&(Ask<(StartBuyPrice-Level11*k*Point))) {
LooseNowBuy();
...
if ((CountSell==11)&&(Bid>(StartSellPrice+Level11*k*Point))) {
...
if ((CountBuy==12)&&(Ask<(StartBuyPrice-Level12*k*Point))) {
LooseNowBuy();
...
if ((CountSell==12)&&(Bid>(StartSellPrice+Level12*k*Point))) {
...
if ((CountBuy==13)&&(Ask<(StartBuyPrice-Level13*k*Point))) {
LooseNowBuy();
...
if ((CountSell==13)&&(Bid>(StartSellPrice+Level13*k*Point))) {
...
if ((CountBuy==14)&&(Ask<(StartBuyPrice-Level14*k*Point))) {
LooseNowBuy();
...
if ((CountSell==14)&&(Bid>(StartSellPrice+Level14*k*Point))) {
...
if (TotalBLt!=0){GoGoSell=TotalBLt*Percent/100/lot1; if (GoGoSell<(AccountEquity()/35000)) {GoGoSell=AccountEquity()/35000;}                      }
if (GoGoSell<1) {GoGoSell=1;} if (GoGoSell>CriticalCoef){GoGoSell=CriticalCoef;}
if ((CountBuy==0)&&(CountSell==0)&&(DinamicLot==true)){Print("Рассчёт начального ордера");GoGoSell=AccountEquity()/35000;}
...
if (TotalSLt!=0){ GoGoBuy=TotalSLt*Percent/100/lot1; if (GoGoBuy<(AccountEquity()/35000)) {GoGoBuy=AccountEquity()/35000;} }
if (GoGoBuy<1) {GoGoBuy=1;}if (GoGoBuy>CriticalCoef){GoGoBuy=CriticalCoef;}
if ((CountBuy==0)&&(CountSell==0)&&(DinamicLot==true)){Print("Рассчёт начального ордера");GoGoBuy=AccountEquity()/35000;}
Sleep(2000);
Print ("Открытие 1-го ордера");
